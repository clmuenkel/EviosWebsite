  ...
  return (
    <section id="pillars" className="section-block section-divider">
      <div className="section-frame">
        ...
        <div ref={containerRef} className="mt-10 flex w-full flex-col gap-[18px] md:flex-row">
          {PILLARS.map((p, i) => (
            <div
              key={p.id}
              data-pillar={p.id}
            ...
            >
              ...
              <div className="p-[22px] pb-5">
                ...
                <Link
                  href={p.demoHref}
                  className="mt-4 inline-flex items-center gap-1.5 rounded-lg border border-brand-accent/20 bg-brand-accent/5 px-4 py-2 text-sm font-semibold text-brand-accent transition-all hover:border-brand-accent/40 hover:bg-brand-accent/10"
                >
                  Watch demo
